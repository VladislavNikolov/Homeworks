...
class SortStudents
{
    static void Main()
    {
        List<Student> students = new List<Student>
        {
            ...
            new Student("Pesho", "Goskov", 19, "1546", "07113", "petkov@abv.bg", new List<int> {5, 2, 5, 6}, 2),
            ...
            new Student("Mariika", "Marieva", 20,"1556", "112345", "pakmail@abv.bg", new List<int> {4, 2, 6, 3}, 2),
            new Student("Vlado", "Petkov", 36, "1545", "524354", "zashto@hotmail.com", new List<int> {6, 2, 6, 6}, 1)
        };

        var studentsQueryLambda = students.OrderByDescending(student => student.FirstName).
            ThenByDescending(student => student.LastName);

        Console.WriteLine("Students sorted by first name and last name in descending order using Lambda expressions:");
        ...
        var studentsQueryLINQ =
            from student in students
            orderby student.FirstName descending, student.LastName descending
            select student;

        Console.WriteLine("Students sorted by first name and last name in descending order using LINQ query:");
